...
import { isValidAmm, printSimulateInfo } from './utils'
...
export const swap = async () => {
    ...
    const amountIn = 50_000_000_000
    const inputMint = 'AYxoo4m42K3d7cMG4ERiBqDmyBMG8UfHq1chBjAvZ5Ba'
    const poolId = 'HUpss2qse4HeEgGSFY3EWutoTiDx926oWY5TC1RieJZC' // wukong-naruto pool
